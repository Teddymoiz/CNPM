                            ...
                            <div class="footer-text">
                                <ul>
                                    <li>
                                        ...
                                        <p>54 P. Triều Khúc, Thanh Xuân Nam, Thanh Xuân, Hà Nội</p>
                                    </li>
                                    <li>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 r-margin-top wide-mobile">
                        <div class="single-text">
                            ...
                            <div class="clearfix instagram">
                                <ul>
                                    <li><a href="https://www.facebook.com/longtr999999999?mibextid=JRoKGi"
                                            target="_blank"><img src="public/img/footer/in1.png" alt="Facebook" /></a>
                                    </li>
                                    <li><a href="https://zalo.me/0344020078" target="_blank"><img
                                                src="https://cdn.haitrieu.com/wp-content/uploads/2022/01/Logo-Zalo-Arc.png"
                                                alt="Zalo" width="60" height="60" /></a></li>
                                    <li><a href="mailto:longtr99999@gmail.com"><img src="public/img/footer/in3.png"
                                                alt="Email" /></a></li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <p>&copy; Xây dựng Hòa Phát. All Rights Reserved.</p>
                </div>
